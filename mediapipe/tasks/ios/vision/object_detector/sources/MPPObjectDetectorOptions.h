...
/**
 * An object that confirms to `MPPObjectDetectorLiveStreamDelegate` protocol. This object must implement
 ...
 */
@property(nonatomic, weak, nullable) id<MPPObjectDetectorLiveStreamDelegate> objectDetectorLiveStreamDelegate;
