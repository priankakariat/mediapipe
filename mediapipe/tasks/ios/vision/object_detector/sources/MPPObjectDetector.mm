  ...
  if (self) {
    MPPTaskInfo *taskInfo = [[MPPTaskInfo alloc]
        initWithTaskGraphName:kTaskGraphName
                ...
                outputStreams:@[
                  [NSString
                      stringWithFormat:@"%@:%@", kDetectionsTag, kDetectionsStreamName],
...
- (nullable MPPObjectDetectionResult *)detectINImage:(MPPImage *)image
  ...
  return
      [MPPObjectDetectionResult objectDetectionResultWithDetectionsPacket:
                                    outputPacketMap.value()[kDetectionsStreamName.cppString]];
}
