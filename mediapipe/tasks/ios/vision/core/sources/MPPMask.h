...
/**
 * Initializes an `MPPMask` object of tyep `MPPMaskDataTypeUInt8` with the given `UInt8*` data, width and height.
 *
...
/**
 * Initializes an `MPPMask` object of tyep `MPPMaskDataTypeFloat32` with the given `float*` data, width and height.
 *
