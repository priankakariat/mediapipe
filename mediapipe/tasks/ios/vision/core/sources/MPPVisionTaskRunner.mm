      ...
      if (packetsCallback) {
        [MPPCommonUtils
            createCustomError:error
                  ...
                  description:@"The vision task is in image or video mode. The delegate must not be"
        ...
        [MPPCommonUtils
            createCustomError:error
                  ...
                  description:
                      ...
                      @"delegate of the task in the its options to ensure asynchronous delivery of "
                      @"results."];
        return nil;
      }
      break;
