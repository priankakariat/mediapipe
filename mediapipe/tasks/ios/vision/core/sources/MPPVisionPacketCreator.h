 ...
 * error will be saved.
 *
 * @return The MediaPipe packet containing the `RenderData` constructed from the given `MPPRegionOfInterest`.
 */
+ (std::optional<mediapipe::Packet>)createRenderDataPacketWithRegionOfInterest:(MPPRegionOfInterest *)regionOfInterest error:(NSError **) error;
