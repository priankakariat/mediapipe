...
static MPPFileInfo *const kCatsAndDogsImageFileInfo = [[MPPFileInfo alloc] initWithName:@"cats_and_dogs" type:@"jpg"];
...
static MPPFileInfo *const kCatsAndDogsMaskImage1FileInfo =
    [[MPPFileInfo alloc] initWithName:@"scats_and_dogs_mask_dog1" type:@"png"];
static MPPFileInfo *const kCatsAndDogsMaskImage2FileInfo =
    [[MPPFileInfo alloc] initWithName:@"scats_and_dogs_mask_dog2" type:@"png"];    
...
- (void)testSegmentWithCategoryMaskSucceeds {
  ...
  MPPInteractiveSegmenter *interactiveSegmenter = [self createInteractiveSegmenterWithOptionsSucceeds:options];

MPPRegionOfInterest *regionOfInterest = [[MPPRegionOfInterest alloc] initWithNormalizedKeyPoint:[[MPPNormalizedKeypoint alloc] initWithLocation: CGPointMake(0.44, 0.7) label:nil score:0.0f]];
...
- (MPPInteractiveSegmenterOptions *)interactiveSegmenterOptionsWithModelFileInfo:(MPPFileInfo *)fileInfo {
...
- (MPPInteractiveSegmenter *)createInteractiveSegmenterWithOptionsSucceeds:(MPPInteractiveSegmenterOptions *)options {
  NSError *error;
  MPPInteractiveSegmenter *interactiveSegmenter = [[MPPInteractiveSegmenter alloc] initWithOptions:options
                                                                           error:&error];
...
- (void)assertResultsOfSegmentImageWithFileInfo:(MPPFileInfo *)imageFileInfo
              regionOfInterest:(MPPRegionOfInterest *)regionOfInterest
                                         usingInteractiveSegmenter:(MPPInteractiveSegmenter *)interactiveSegmenter
...
regionOfInterest:(MPPRegionOfInterest *)regionOfInterest
  ...
  MPPImageSegmenterResult *result = [interactiveSegmenter segmentImage:image regionOfInterest:regionOfInterest error:&error];
