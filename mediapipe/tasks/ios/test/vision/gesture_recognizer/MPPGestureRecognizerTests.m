...
static NSString *const kGestureRecognizerBundleAssetFileName = @"gesture_recognizer";
...
- (MPPGestureRecognizerOptions *)gestureRecognizerOptionsWithModelName:(NSString *)modelName {
  NSString *modelPath = [self filePathWithName:modelName extension:@"task"];
  MPPGestureRecognizerOptions *gestureRecognizerOptions = [[MPPGestureRecognizerOptions alloc] init];
  gestureRecognizerOptions.baseOptions.modelAssetPath = modelPath;

  return gestureRecognizerOptions;
}

- (void)assertCreateGestureRecognizerWithOptions:(MPPGestureRecognizerOptions *)gestureRecognizerOptions
...
//                  usingObjectDetector:(MPPGestureRecognizer *)gestureRecognizer
...
- (void)testDetectWithModelPathSucceeds {
  NSString *modelPath = [self filePathWithName:kGestureRecognizerBundleAssetFileName extension:@"task"];
  NSLog(@"PATHHHH: %@",modelPath);
  NSError *error = nil;
  MPPGestureRecognizer *gestureRecognizer = [[MPPGestureRecognizer alloc] initWithModelPath:modelPath
                                                                             error:&error];
  NSLog(@"%@",error.localizedDescription);                                                                         
  XCTAssertNotNil(gestureRecognizer);

  MPPImage *mppImage = [self imageWithFileInfo:kTwoHandsImage];
  MPPGestureRecognizerResult *gestureRecognizerResult = [gestureRecognizer recognizeImage:mppImage error:nil];


  // [self assertResultsOfRecognizeImageWithFileInfo:kTwoHandsImage
