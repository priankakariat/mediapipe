...
//   faceStylizerOptions.baseOptions.modelAssetPath = kFaceStylizerBundleAssetFileInfo.path;

//   MPPFaceStylizer *faceStylizer =
//       [[MPPFaceStylizer alloc] initWithOptions:faceStylizerOptions
//                                              error:nil];
...
// - (MPPFaceStylizerOptions *)faceStylizerOptionsWithModelFileInfo:(MPPFileInfo *)modelFileInfo {
//   MPPFaceStylizerOptions *faceStylizerOptions = [[MPPFaceStylizerOptions alloc] init];
